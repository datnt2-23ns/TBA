...
//                            }
//                        } catch (e: Exception) {
//                            println("Lỗi phân tích ngày: ${booking.date}, ${e.message}")
//                        }
//                    }
//                }
//            }
...
//        ) {
//            item {
//                TopBar(user = user, title = "Lịch sử đặt vé") // Thay BookingHistoryTopBar bằng TopBar
//            }
//
//            item {
//                Column(
//                    modifier = Modifier
//                        .fillMaxWidth()
//                        .padding(horizontal = 32.dp, vertical = 16.dp) // Cập nhật padding
//                ) {
...
//                            Divider(
//                                color = colorResource(R.color.lightGreyWhite), // Màu lightGreyWhite
//                                thickness = 1.dp,
