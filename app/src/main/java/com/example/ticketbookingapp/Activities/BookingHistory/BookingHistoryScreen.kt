...
fun BookingHistoryScreen(user: UserModel) {
    ...
    val tabTitles = listOf("Chuyến sắp tới", "Đã bay", "Hoãn bay", "Đang bay")
            ...
            item {
                Column(
                    ...
                    when (selectedTabIndex) {
                        0 -> { // Chuyến bay sắp tới
                            BlueTitle("Chuyến bay sắp tới")
                            Spacer(modifier = Modifier.height(16.dp))
                            if (upcomingBookings.isEmpty()) {
                                Text(
                                    text = "Không có chuyến bay sắp tới",
                        ...
                        1 -> { // Đã bay
                            BlueTitle("Chuyến bay đã bay")
                            Spacer(modifier = Modifier.height(16.dp))
                            if (pastBookings.isEmpty()) {
                                Text(
                                    text = "Không có chuyến bay đã bay",
                                    color = colorResource(R.color.darkBlue),
                                    fontWeight = FontWeight.Normal,
                                    fontSize = 16.sp,
                                    modifier = Modifier.padding(top = 8.dp)
                        ...
                        2 -> { // Chuyến bay hoãn
                            BlueTitle("Hoãn chuyến bay")
                            Spacer(modifier = Modifier.height(16.dp))
                            if (delayedBookings.isEmpty()) {
                                Text(
                                    text = "Không có chuyến bay hoãn",
                                    color = colorResource(R.color.darkBlue),
                                    fontWeight = FontWeight.Normal,
                                    fontSize = 16.sp,
                                    modifier = Modifier.padding(top = 8.dp)
                        ...
                        3 -> { // Đang bay
                            BlueTitle("Chuyến bay đang bay")
                            Spacer(modifier = Modifier.height(16.dp))
                            if (inFlightBookings.isEmpty()) {
                                Text(
                                    text = "Không có chuyến bay đang bay",
                                    color = colorResource(R.color.darkBlue),
                                    fontWeight = FontWeight.Normal,
                                    fontSize = 16.sp,
                                    modifier = Modifier.padding(top = 8.dp)
